...
const StateEditMembers = () => {
  ...
  const handleSearch = () => {
    ...
    if (selectedBranch) {
      filteredResults = filteredResults.filter((member) => member.branch === selectedBranch);
    }
  ...
  return (
    <MainCard title="Edit Members">
      <Box component="form" noValidate>
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6} md={4}>
            <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">Search For</InputLabel>
              <Select value={searchFor} onChange={(e) => setSearchFor(e.target.value)} label="Search For">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <TextField label="Enter Text" variant="outlined" fullWidth value={searchText} onChange={(e) => setSearchText(e.target.value)} />
          </Grid>
...
export default StateEditMembers;
